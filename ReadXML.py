...
#Read XML file
num_of_targets = 96         #number of testFiles
counter = 1
...
def GenerateXML(fileName) :
  ...
  while counter != num_of_targets+1: 
        b1 = gfg.SubElement(m4, "Path")                 #READ <Target>
        b1.text = f"y:\\testFile{counter}.dat"
        counter += 1
        ...
        b5.text = "4096"
        b6 = gfg.SubElement(m4, "BaseFileOffset")
        b6.text = "132096"
...
if __name__ == "__main__":
  GenerateXML(f"AccReadProfile_H264_{num_of_targets}C_v3.xml")
